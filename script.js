...
const translations = {
  en: {
    ...
    teach_q4: "Coach classmates on using spreadsheets (Excel/Sheets) to sanity‑check calculations.",
    teach_s1: "Tutored high school math/physics; designed quick rubric checks for weekly quizzes.",
  ...
  zh: {
    ...
    teach_q4: "辅导同学使用电子表格(Excel/Sheet)快速验证计算合理性。",
    teach_s1: "辅导高中数学/物理，为每周小测验设计快速量规评分表。",
...
function updateLanguage(lang) {
  ...
  const btnSpan = document.getElementById('langBtnText');
